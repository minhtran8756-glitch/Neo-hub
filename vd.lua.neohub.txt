...
Toggles.AutoPlayHandle = UPlaySection:Toggle({
   ...
   Desc = "Automatically plays for you, will be improving further(tự động chơi)",
   Value = false,
   Callback = function(state)
...
Toggles.RunHandle = UPlaySection:Toggle({
   Title =  "Auto Run (BETA)",
   Desc = "Runs from killer if he's close and you're survivor(tự động chạy)",
   Value = false,
   Callback = function(state)
...
Toggles.FarmHandle = UPlaySection:Toggle({
   ...
   Desc = "Farms generators if you're survivor, survivors if you're killer(tự động đi sửa điện)",
   Value = false,
   Callback = function(state)
...
Toggles.WallHugHandle = UPlaySection:Toggle({
   Title =  "Wall Hug",
   Desc = "Hugs wall while running/farming/looping(tổng hợp)",
   Value = false,
   Callback = function(state)
...
Toggles.InfThingsHandle = KillerBlatantSection:Toggle({
    Title = "Infinite Abilities " .. (getTag(lp.Name) == "[ ⚔️ ]" and "(⚔️)" or ""),
...
Toggles.OneTapHandle = KillerSection:Toggle({
       Title = "Damage Aura",
       Desc = "Throws cycles of hits at the location you're facing(đòn đánh liên hoàn)",
       Value = false,
       Callback = function(state)
             DamageAura = state
...
Toggles.AutoAimChargedHandle = KillerSection:Toggle({
       ...
       Desc = "Automatically aims charged spear to the closest survivor(tự động aim giáo đã tụ lực)",
       Value = false,
       Callback = function(state)
...
Toggles.AutoAimNormalHandle = KillerSection:Toggle({
       ...
       Desc = "Automatically aims spear to the closest survivor(tự động aim giáo thường)",
       Value = false,
       Callback = function(state)
...
Toggles.AntiFlashlightHandle = KillerMiscSection:Toggle({
       ...
       Desc = "Removes flashlight brightness(không bị đèn pin chiếu sáng)",
       Value = false,
       Callback = function(state)
...
Toggles.AntiSlowHandle = KillerMiscSection:Toggle({
       ...
       Desc = "Removes negative walk speed effects(không bị giảm tốc độ)",
       Value = false,
       Callback = function(state)
...
Toggles.NoStunHandle = KillerMiscSection:Toggle({
    Title = "No Stun(Beta",
    Desc = "Removes falling negative effects(không bị choáng)",
    Value = false,
    Callback = function(state)
        NoStunToggle = state 
    end
...
Toggles.AutoShootHandle = SurvSection:Toggle({
       Title = "Auto Attack",
       Desc = "Automatically aims to target and shoots him, must have revolver/flashlight and target must be in FOV(tự động nhắm)",
       Value = false,
       Callback = function(state)
             Autoshoot = state
             if Autoshoot then
...
Toggles.AutoParryHandle = SurvDefSection:Toggle({
       ...
       Desc = "Automatically stuns killer parrying him, must have parrying dagger as survivor(tự động đỡ đòn bằng kiếm)",
       Value = false,
       Callback = function(state)
             Autoparry = state
       end
...
Toggles.ParrySliderHandle = SurvDefSection:Slider({
       Title = "Parry Radius",
       Desc = "Modify the radius of auto parry(khoảng cách đỡ đòn)",
	Value = { Min = 5, Max = 30, Default = 10 },
	Callback = function(Value)
...
Toggles.ParryMethodHandle = SurvDefSection:Dropdown({
       Title =  "Parry Method",
       Desc = "Choose auto parry method(chế độ đỡ đòn)",
...
Toggles.UnhookAuraHandle = SurvDefSection:Toggle({
    Title = "Unhook Aura",
    Desc = "Unhooks hooked players when you're close(tự động giải cứu người cắm trên gai khi ở gần)",
    Value = false,
    Callback = function(state)
...
Toggles.NoFallHandle = SurvDefSection:Toggle({
    Title = "No Fall",
    Desc = "Removes falling negative effects(không bị làm chậm khi rơi)",
    Value = false,
    Callback = function(state)
...
Toggles.AutoDropHandle = SurvDefSection:Toggle({
       ...
       Desc = "Drops pallete right to killer, must be near(tự động thả ván gỗ khi killer lại gần)",
       Value = false,
       Callback = function(state)
...
Toggles.AutoDropSetHandle = SurvDefSection:Toggle({
       ...
       Desc = "Drops pallete even if killer is carrying you and passing after pallet(tự động thả ván gỗ khi đang bị Killer bế)",
       Value = false,
       Callback = function(state)
...
Toggles.PerfectGenHandle = SurvMiscSection:Toggle({
    ...
    Desc = "Does generator skill check at perfect spot(tự động sửa điện không bị fall)",
    Value = false,
    Callback = function(state)
        if state then
...
Toggles.PerfectHealHandle = SurvMiscSection:Toggle({
    ...
    Desc = "Does heal skill check at perfect spot(tự động chữa lành không bị fall)",
    Value = false,
    Callback = function(state)
        if state then
...
Toggles.AntiGFailHandle = SurvMiscSection:Toggle({
       ...
       Desc = "Failing generator skill check will not do anything(vô hiệu hóa nổ máy phát điện)",
       Value = false,
       Callback = function(state)
             AntiGFail = state
       end
...
Toggles.RemoveClothingsHandle = SurvMiscSection:Toggle({
       ...
       Desc = "Nakes veil killer(the veil không quần áo 🌚)",
       Value = false,
       Callback = function(state)
...
Toggles.FOVSliderHandle = TabHandles.Esp:Slider({
       Title = "FOV Radius",
       Desc = "Modify the radius of FOV(tăng góc nhìn)",
...
Toggles.NoclipHandle = TabHandles.Player:Toggle({
	Title = "Noclip",
	Desc = "Pass through walls with this toggle on(đi xuyên tường)",
	Value = false,
	Callback = function(state)
		NoclipToggle = state
		if state then
...
Toggles.WsToggleHandle = TabHandles.Player:Toggle({
	...
	Desc = "Set your speed to your preference(tăng tốc độ)",
	Value = false,
	Callback = function(state)
		WalkToggle = state
		firststate = state
